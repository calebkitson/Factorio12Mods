data:extend(
{
	...
	-- mixing-recipe
	{
		...
		--category = "smelting",		
		enabled = "true", energy_required = 2.0, ingredients = {{"y-crush-yres1", 10}, {"y-crush-yres2", 10}}, result = "y-richdust", result_count = 20,subgroup = "yuoki-formpress",				
		order="m-refined-",
	},	
	...
	-- smeltings
	{
		...
		enabled = "true", energy_required = 4.0, ingredients = {{"y-richdust", 20}}, results = { {type="item", name="y-unicomp-a2", amount=1,}, {type="item", name="y-slag", amount=1,},}, subgroup = "y-raw-material",				
		order="m-refined-x1",
	},	
	{
		type = "recipe",
		...
		enabled = "true", energy_required = 3.0, ingredients = {{"y-richdust", 3}}, results = {{type="item", name="y-orange-stuff", amount=2,},}, subgroup = "y-raw-material",				
		order="m-refined-x2",
	},	
	
	{
		...
		enabled = "true", energy_required = 4.0, ingredients = {{"y-crush-yres1", 3}}, results = { {type="item", name="y-refined-yres1", amount=1,}, {type="item", name="y-slag", amount=1,},}, subgroup = "y-raw-material",				
		order="m-refined-",
	},
	{
		type = "recipe",
		...
		enabled = "true", energy_required = 8.0, ingredients = {{"y-refined-yres1", 3},}, result = "y-unicomp-raw", result_count = 1, subgroup = "y-raw-material",					
		order="m-refined-",
	},	
	{
		type = "recipe",
		...
		enabled = "true", energy_required = 6.0, ingredients = {{"y-crush-yres2", 2}}, results = { {type="item", name="y-refined-yres2", amount=1,}, {type="item", name="y-slag", amount=1,}, }, subgroup = "y-raw-material",								
		order="m-refined-",
	},
	{
		type = "recipe",
		...
		category = "yuoki-formpress-recipe",		
		enabled = "true", energy_required = 10.0, ingredients = {{"y-refined-yres2", 2},}, result = "y-raw-fuelnium", result_count = 1, subgroup = "y-raw-material",					
		order="m-refined-",
	},	
	{
		type = "recipe",
	...
	]]
	{
		...
		group = "yuoki", subgroup = "yuoki-formpress", order="m-a-copper",		
	},
	
	{
		...
		group = "yuoki", subgroup = "yuoki-formpress", order="m-a-iron",		
	},	
			...
			
	{
		...
		subgroup = "y-raw-material", order="m-refined-",
	},	
