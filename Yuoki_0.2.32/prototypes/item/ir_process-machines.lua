data:extend(
{
	...
	{
		type = "item",
		name = "y-dirtwasher", place_result = "y-dirtwasher", stack_size = 20,
	...
	{
		type = "item",
		name = "y-heat-form-press", place_result = "y-heat-form-press",	stack_size = 20,
	...
	{
		type = "item",
		name = "y-mining-drill", place_result = "y-mining-drill", stack_size = 20,
	...
	{
		type = "item",
		name = "y-mining-drill-e2", place_result = "y-mining-drill-e2", stack_size = 20,
	...
	{
		type = "item",
		name = "y-underground-drill", place_result = "y-underground-drill", stack_size = 20,
	...
	{
		type = "item",
		name = "y-crusher", place_result = "y-crusher", stack_size = 20,
	...
	{
		type = "item",
		name = "y-atomic-quantum-composer", place_result = "y-atomic-quantum-composer", stack_size = 5,
	...
	{
		type = "item",
		name = "y-atomic-constructor", place_result = "y-atomic-constructor", stack_size = 5,
	...
	{
		type = "item",
		name = "y-water-gen", place_result = "y-water-gen", stack_size = 10,
	...
	{
		type = "item",
		name = "y-water-gen-e", place_result = "y-water-gen-e", stack_size = 10,
