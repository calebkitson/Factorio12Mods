data:extend(
{
	...
	
	{
		...
		group = "yuoki", subgroup = "y-fluid-storage", stack_size = 10, flags = {"goes-to-main-inventory"}, order = "tank-a1",
	},
	{
		type = "item",
		name = "y-tank-4500", place_result = "y-tank-4500",
		icon = "__Yuoki__/graphics/entity/tank-4500-icon.png",
		group = "yuoki", subgroup = "y-fluid-storage", stack_size = 10, flags = {"goes-to-main-inventory"}, order = "tank-b1",
	},
	{
		type = "item",
		name = "y-tank-8000", place_result = "y-tank-8000",
		icon = "__Yuoki__/graphics/entity/tank-8000-icon.png",
		group = "yuoki", subgroup = "y-fluid-storage", stack_size = 10, flags = {"goes-to-main-inventory"}, order = "tank-c1",
	},	
	{
		type = "item",
		name = "y-tank-24k", place_result = "y-tank-24k",
		icon = "__Yuoki__/graphics/entity/tank-48k-icon.png",
		group = "yuoki", subgroup = "y-fluid-storage", stack_size = 3, flags = {"goes-to-main-inventory"}, order = "tank-c2",
	},	
