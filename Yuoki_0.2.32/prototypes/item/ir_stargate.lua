data:extend(
{
	...
	-- fuel-cell-c	
	{ type = "item", name = "y-fuel-cell-c", icon = "__Yuoki__/graphics/icons/fuel_cell_c.png", flags = {"goes-to-main-inventory"}, subgroup = "y-energy", fuel_value = "10GJ", stack_size = 500,},
	...
	-- fame	
	{ type = "item", name = "y-fame", icon = "__Yuoki__/graphics/icons/fame-icon.png", flags = {"goes-to-main-inventory"}, subgroup = "y-stargate-f", stack_size = 10000,},
	...
	-- stargate itself
	{ type = "item", name = "y-stargate", place_result = "y-stargate", icon = "__Yuoki__/graphics/icons/laika-gate-icon.png", flags = {"goes-to-main-inventory"}, group = "Yuoki", subgroup = "y-tech", stack_size = 2,},			
	...
	-- 40-Users
	{ type = "item", name = "y-fame-gen", place_result = "y-fame-gen", icon = "__Yuoki__/graphics/entity/thanks-icon.png", flags = {"goes-to-main-inventory"}, group = "Yuoki", subgroup = "y-tech", stack_size = 5,},			
