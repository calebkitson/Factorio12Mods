data:extend(
{
	...
	{ type = "item", name = "y_lamp_red", place_result = "y_lamp_red", icon = "__Yuoki__/graphics/entity/lamps/y_lamp_red_icon.png", flags = {"goes-to-quickbar"}, subgroup = "y-lamps", stack_size = 50, order = "l-a", },
	{ type = "item", name = "y_lamp_green", place_result = "y_lamp_green", icon = "__Yuoki__/graphics/entity/lamps/y_lamp_green_icon.png", flags = {"goes-to-quickbar"}, subgroup = "y-lamps", stack_size = 50, order = "l-a", },
	{ type = "item", name = "y_lamp_blue", place_result = "y_lamp_blue", icon = "__Yuoki__/graphics/entity/lamps/y_lamp_blue_icon.png", flags = {"goes-to-quickbar"}, subgroup = "y-lamps", stack_size = 50, order = "l-a", },
	{ type = "item", name = "y_lamp_yellow", place_result = "y_lamp_yellow", icon = "__Yuoki__/graphics/entity/lamps/y_lamp_yellow_icon.png", flags = {"goes-to-quickbar"}, subgroup = "y-lamps", stack_size = 50, order = "l-a", },
