	...
	y_laser2x2 =
	{
		filename = "__Yuoki__/graphics/entity/laser2x2/laser2x2-place.png",
		priority = "medium",
		width = 130,
		height = 130,
		direction_count = 8,
...
data:extend({	 
		...
		
		{
			...
			prepared_animation =
			{
				filename = "__Yuoki__/graphics/entity/laser2x2/laser2x2-anim.png",
				priority = "medium", width = 130, height = 130, shift = {0.475, -0.1},
				direction_count = 64,
				frame_count = 1,
				line_length = 8,
				axially_symmetrical = false,
