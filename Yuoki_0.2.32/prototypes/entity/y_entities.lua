...
{  
...

	{
		...
		icon = "__Yuoki__/graphics/icons/amfc_compressor_icon.png",
		flags = {"placeable-neutral","placeable-player", "player-creation"},
	...
	-- water generator - solid fuel
	{
		...
		picture =
		{
			filename = "__Yuoki__/graphics/entity/alien_water_gen.png",			
			width = 128,
			height = 128,
			shift = {0.65, -0.2}
		},
		animation =
		{
			filename = "__Yuoki__/graphics/entity/alien-water-anim.png",
			priority = "high",
			width = 128,
			height = 128,
			frame_count = 12,
	...
	-- water generator - electric fuel
	{
		...
		picture =
		{
			filename = "__Yuoki__/graphics/entity/alien-water-e.png",			
			width = 128,
			height = 128,
			shift = {0.65, -0.2}
		},
		animation =
		{
			filename = "__Yuoki__/graphics/entity/alien-water-e-anim.png",
			priority = "high",
			width = 128,
			height = 128,
			frame_count = 12,
	...
	-- stargate object	
	{
		...
		picture =
		{
			filename = "__Yuoki__/graphics/entity/aika-gate_off.png",			
			width = 140,
			height = 140,
			shift = {0.65, -0.2}
		},
		animation = {
			filename = "__Yuoki__/graphics/entity/laika-gate_on.png",
			priority = "medium",
			width = 140,
			height = 140,
			frame_count = 1,						
