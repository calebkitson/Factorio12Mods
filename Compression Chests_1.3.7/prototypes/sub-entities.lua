...
local entIcon = "__Compression Chests__/graphics/Compression chest - Icon.png"
...
local entPicture = {filename = "__Compression Chests__/graphics/Compression Chest.png", priority = "extra-high", width = 52, height = 34, shift = {0.2625, 0}}
