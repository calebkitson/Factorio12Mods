...
{
  {
    ...
    animation =
    {
      filename = "__Electric Furnaces__/graphics/entity/electric-stone-furnace/electric-stone-furnace.png",
      priority = "extra-high",
      width = 81,
      height = 64,
      frame_count = 1,
  ...
  },
  {
    ...
    animation =
    {
      filename = "__Electric Furnaces__/graphics/entity/electric-furnace-2/electric-furnace-2-base.png",
      priority = "high",
      width = 129,
      height = 100,
      frame_count = 1,
