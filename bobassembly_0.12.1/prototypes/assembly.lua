...
data.raw["recipe"]["assembling-machine-3"].ingredients = {{"assembling-machine-2", 1},{"steel-plate", 9}}
...
data:extend(
{
...

  {
    ...
    animation =
    {
      filename = "__bobassembly__/graphics/entity/assembling-machine-5/assembling-machine-5.png",
      priority = "high",
      width = 142,
      height = 113,
      frame_count = 32,
...
data:extend(
{
...

  {
    ...
    animation =
    {
      filename = "__bobassembly__/graphics/entity/assembling-machine-6/assembling-machine-6.png",
      priority = "high",
      width = 142,
      height = 113,
      frame_count = 32,
