...
-- register our handler
-----------------------------------------------------------
game.on_event(defines.events.on_tick, ldEB_Tick)
...
-- register our handler
-----------------------------------------------------------
game.on_event(defines.events.on_built_entity, ldEB_BoilerCreated)
game.on_event(defines.events.on_robot_built_entity, ldEB_BoilerCreated)
...
-- register our handler
-----------------------------------------------------------
game.on_event(defines.events.on_preplayer_mined_item, ldEB_BoilerPreMined)
game.on_event(defines.events.on_robot_pre_mined, ldEB_BoilerPreMined)
...
-- register our handler
-----------------------------------------------------------
game.on_event(defines.events.on_entity_died, ldEB_BoilerDied)
