...
ExplosiveTermite.animation.filename = "__Explosive_Termites__/graphics/Termite.png"
...
AlienExplosiveTermite.animation.filename = "__Explosive_Termites__/graphics/Alien-Termite.png"
