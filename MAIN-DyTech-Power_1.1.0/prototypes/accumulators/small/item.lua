...
{
  {
    ...
    subgroup = "dytech-energy-accu-small",
    order = "b[mk2]",
    place_result = "small-basic-accumulator",
    stack_size = 50
  },
  {
    type = "item",
    ...
    subgroup = "dytech-energy-accu-small",
    order = "b[mk2]",
    place_result = "small-basic-accumulator-mk2",
    stack_size = 50
  },
  {
    type = "item",
    ...
    subgroup = "dytech-energy-accu-small",
    order = "c[mk3]",
    place_result = "small-basic-accumulator-mk3",
    stack_size = 50
  },
  {
    type = "item",
    ...
    subgroup = "dytech-energy-accu-small",
    order = "d[mk4]",
    place_result = "small-basic-accumulator-mk4",
    stack_size = 50
  },
  {
    type = "item",
    ...
    subgroup = "dytech-energy-accu-small",
    order = "e[mk5]",
    place_result = "small-basic-accumulator-mk5",
    stack_size = 50
  },
  {
    type = "item",
    ...
    subgroup = "dytech-energy-accu-small",
    order = "f[mk6]",
    place_result = "small-basic-accumulator-mk6",
    stack_size = 50
  },
}
)