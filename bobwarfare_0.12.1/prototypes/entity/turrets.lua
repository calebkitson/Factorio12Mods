...
function bob_gun_turret_extension_mask(inputs)
return
{
...
return
  {
    ...
    attacking_speed = 0.5,
    folded_animation = bob_gun_turret_extension{frame_count=1, line_length = 1, tint = inputs.tint},
    preparing_animation = bob_gun_turret_extension{tint = inputs.tint},
    folding_animation = bob_gun_turret_extension{run_mode = "backward", tint = inputs.tint},
    prepared_animation = bob_gun_turret_attack{frame_count=1, tint = inputs.tint},
    attacking_animation = bob_gun_turret_attack{tint = inputs.tint},
    base_picture =
    {
      layers =
      {
...
function bob_laser_turret_extension_mask(inputs)
return
{
...
return
{
  layers =
  {
    ...
    bob_laser_turret_extension_mask(inputs),
...
data:extend(
{
--  bob_gun_turret(name, health, inventory_size, automated_ammo_count , ammo_category, damage_modifier, cooldown, range, tint)

  bob_gun_turret{name = "bob-gun-turret-2", health = 500, inventory_size = 1, automated_ammo_count = 10, ammo_category = "bullet", damage_modifier = 2.4, cooldown = 5, range = 18, tint = blue},
  bob_gun_turret{name = "bob-gun-turret-3", health = 600, inventory_size = 2, automated_ammo_count = 20, ammo_category = "bullet", damage_modifier = 2.8, cooldown = 4, range = 19, tint = purple},
  bob_gun_turret{name = "bob-gun-turret-4", health = 700, inventory_size = 2, automated_ammo_count = 20, ammo_category = "bullet", damage_modifier = 3.2, cooldown = 3, range = 20, tint = green},
  bob_gun_turret{name = "bob-gun-turret-5", health = 800, inventory_size = 3, automated_ammo_count = 30, ammo_category = "bullet", damage_modifier = 3.6, cooldown = 2, range = 20, tint = red},

  bob_gun_turret{name = "bob-sniper-turret-1", health = 300, inventory_size = 1, automated_ammo_count = 10, ammo_category = "bullet", damage_modifier = 40, cooldown = 120, range = 50, tint = blue},
  bob_gun_turret{name = "bob-sniper-turret-2", health = 500, inventory_size = 1, automated_ammo_count = 10, ammo_category = "bullet", damage_modifier = 60, cooldown = 120, range = 55, tint = purple},
  bob_gun_turret{name = "bob-sniper-turret-3", health = 700, inventory_size = 1, automated_ammo_count = 10, ammo_category = "bullet", damage_modifier = 60, cooldown = 90, range = 60, tint = red},

--  bob_laser_turret(name, health, buffer_capacity, input_flow_limit, drain, energy_consumption, projectile, damage_modifier, cooldown, range, tint)

  bob_laser_turret{name = "bob-laser-turret-2", health = 1200, buffer_capacity = "2001kJ", input_flow_limit = "8000kW", drain = "30kW", energy_consumption = "1000kJ", projectile = "bob-blue-laser", damage_modifier = 6, cooldown = 15, range = 26, tint = blue},
  bob_laser_turret{name = "bob-laser-turret-3", health = 1400, buffer_capacity = "3601kJ", input_flow_limit = "12000kW", drain = "36kW", energy_consumption = "1200kJ", projectile = "bob-green-laser", damage_modifier = 8.4, cooldown = 12, range = 27, tint = green},
  bob_laser_turret{name = "bob-laser-turret-4", health = 1600, buffer_capacity = "5601kJ", input_flow_limit = "16800kW", drain = "42kW", energy_consumption = "1400kJ", projectile = "bob-yellow-laser", damage_modifier = 11.2, cooldown = 10, range = 28, tint = yellow},
  bob_laser_turret{name = "bob-laser-turret-5", health = 2000, buffer_capacity = "8001kJ", input_flow_limit = "19200kW", drain = "48kW", energy_consumption = "1600kJ", projectile = "bob-white-laser", damage_modifier = 14.4, cooldown = 10, range = 30, tint = red},
}
)
