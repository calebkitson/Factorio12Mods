...
function builtEntity(event)
	...
	if artyName ~= nil then
		newArty = game.player.surface.create_entity({name = artyName, position = event.created_entity.position, direction = event.created_entity.direction, force = game.forces.player})
		newArtyI = game.player.surface.create_entity({name = artyName.."i", position = event.created_entity.position, direction = event.created_entity.direction, force = game.forces.player})
...
game.on_event(defines.events.on_trigger_created_entity, addTarget)
