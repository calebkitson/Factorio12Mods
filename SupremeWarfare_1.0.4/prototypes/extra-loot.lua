...
if data.raw.unit~=nil then
	...
	table.insert(data.raw.unit["big-spitter"].loot, loot)
end
...
if DyTechW and enableDyTech then
	...
	if data.raw.unit~=nil then
		...
		table.insert(data.raw.unit["adult-berserk-biter"].loot, loot)
	end
	...
	if data.raw.unit~=nil then
		...
		table.insert(data.raw.unit["adult-elder-biter"].loot, loot)
	end
	...
	if data.raw.unit~=nil then
		...
		table.insert(data.raw.unit["adult-king-biter"].loot, loot)
	end
	...
	if data.raw.unit~=nil then
		...
		table.insert(data.raw.unit["adult-queen-biter"].loot, loot)
	end
	...
	if data.raw.unit~=nil then
		...
		table.insert(data.raw.unit["adult-berserk-spitter"].loot, loot)
	end
	...
	if data.raw.unit~=nil then
		...
		table.insert(data.raw.unit["adult-elder-spitter"].loot, loot)
	end
	...
	if data.raw.unit~=nil then
		...
		table.insert(data.raw.unit["adult-king-spitter"].loot, loot)
	end
	...
	if data.raw.unit~=nil then
		...
		table.insert(data.raw.unit["adult-queen-spitter"].loot, loot)
	end
end