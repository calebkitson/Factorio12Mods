...
{
  {
    ...
    icon = "__UpGrade__/graphics/icons/medium-pipe-to-ground.png",
    ...
    icon = "__UpGrade__/graphics/icons/long-pipe-to-ground.png",
    flags = {"placeable-neutral", "player-creation"},
    ...
    icon = "__UpGrade__/graphics/icons/ultra-pipe-to-ground.png",
    flags = {"placeable-neutral", "player-creation"},
    ...
    icon = "__UpGrade__/graphics/icons/continental-pipe-to-ground.png",
    flags = {"placeable-neutral", "player-creation"},
