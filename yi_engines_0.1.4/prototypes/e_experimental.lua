...
{  
	...
	-- Tutorial
	{
		...
		name = "ye_fassembly1",
		icon = "__yi_engines__/graphics/entity/energy2/tut-icon.png",
		...
		{
			north= {
				filename = "__yi_engines__/graphics/entity/energy2/tut-vai1.png",			
				width = 120,
				height = 128,
				shift = {0.3, 0},
				frame_count = 16,
			...
			east= {
				filename = "__yi_engines__/graphics/entity/energy2/tut-hai1.png",			
				width = 120,
				height = 120,
				shift = {0.3, 0},
				frame_count = 16,
